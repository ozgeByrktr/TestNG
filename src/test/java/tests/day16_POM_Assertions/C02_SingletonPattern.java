...
public class C02_SingletonPattern {
    ...
    public void test01() {
        /*
            ...
            ANCAK driver'in bizim istedigmiz islemleri yapabilmesi icin
            oncelikle getDriver() icinde yaptigimiz atama islemerine ihtiyaci var
            ...
            obje olusturulmasini ve o obje ile class'daki class uyelerine erisimi engellemek icin kullanılmıstır
