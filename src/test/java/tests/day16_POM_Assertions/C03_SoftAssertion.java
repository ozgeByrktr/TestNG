...
public class C03_SoftAssertion {
    ...
    public void hardAssertion(){
        ...
        ve java.long.Assertion.Error:verir
        ...
        TestNG bu kınuda da bize daha fazla kontrol yetkisi vermistir
        Istersek TestNG assertion failed olsa bile
        bizi istedigimiz satira kadar
        ...
        Assert.assertFalse(sayi%3==0,"sayi 3 e bolunememeli");// sayinin 3 ile bolınemedigini test edin
    ...
    public void softAssertionTesti(){
        ...
        failed olan olsa bile, tum assertionlar calismaya devam eder

        assertAll() calistiginda
        failed olan assertionlara ait raporu verir
        ANCAK hangi satirda olduklarini vermez

        Selenium hata mesaji da assertAll()'un bulundugu satiri isaret eder

        Failed olan assertionlari kolaylıkla bulabilmemiz icin
         */
        ...
        softAssert.assertFalse(sayi%3==0,"sayi 3 e bolunebilmeli");// sayinin 3 ile bolınemedigini test edin

        softAssert.assertAll();
    }
    //1- tek test methodu ve tek assertion varsa soft assertion a gerek yok
    //2- Assert. assert static , soft assert de instance dır obje olusturulur.
    //3- Soft assertion assert failed olsa bile calismaya devam eder.
    //4- ******* assertAll(); yazmazsak test PASSED olur .Failed olan assertionlar raporlanmaz.******
}
