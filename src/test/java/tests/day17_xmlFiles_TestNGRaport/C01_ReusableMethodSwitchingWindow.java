package tests.day17_xmlFiles_TestNGRaport;
...
public class C01_ReusableMethodSwitchingWindow {
    @Test
    public void test01() throws InterruptedException {
        ...
        softAssert.assertEquals(actualYazi,expectedYazi,"Ilk sayfa text testi");
        ...
        softAssert.assertEquals(actualTitle, expectedTitle,"Ikinci sayfa title testi");
